...
class VolatileGCRingBuffer<T> implements RingBuffer<T> {
    private static final long WRITE_POSITION = Lang.objectFieldOffset(VolatileGCRingBuffer.class, "writePosition");
    ...
    VolatileGCRingBuffer(RingBufferBuilder<T> builder) {
